...
describe('LoginPage', () => {
  ...
  describe('Phone Number Form', () => {
    it('renders the phone number form initially', () => {
      ...
      expect(screen.getByText('Sign in with your phone number')).toBeInTheDocument();
  ...
  describe('OTP Verification Form', () => {
    ...
    it('renders OTP form when OTP is sent', () => {
      ...
      expect(screen.getByText(/we sent a code to 0712345678/i)).toBeInTheDocument();
    ...
    it('submits valid OTP and navigates to dashboard', async () => {
  ...
  describe('UI Elements', () => {
    ...
    it('displays security message', () => {
      ...
      expect(screen.getByText(/secure\. transparent\. community owned\./i)).toBeInTheDocument();
    });
  });
});
