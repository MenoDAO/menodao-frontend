...
export const metadata: Metadata = {
  ...
  description: "Access your MenoDAO dental care membership. Community-powered healthcare financing for Kenyan families—view benefits, make contributions, submit claims, and find clinics near you.",
  keywords: [
    "MenoDAO", "dental care portal", "dental membership",
    ...
    "healthcare financing Kenya", "dental insurance alternative",
  ],
  ...
  openGraph: {
    ...
    description: "Manage your dental care membership, contributions, and claims. Community-powered healthcare financing in Kenya.",
