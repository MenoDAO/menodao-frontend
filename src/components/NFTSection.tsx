...
import { Wallet, ExternalLink, Award, Loader2, CheckCircle, AlertCircle } from "lucide-react";
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm">
        ...
        {custodialWallet && (
          <div className="mb-4 p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
            <p className="text-sm text-gray-600 dark:text-gray-400 mb-1">Custodial Wallet (MenoDAO managed)</p>
        ...
        <div className="border-t dark:border-gray-700 pt-4">
          <p className="text-sm text-gray-600 dark:text-gray-400 mb-3">
            Connect your personal wallet to claim NFTs and manage your membership on-chain.
          </p>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm">
        ...
        {nfts.length === 0 ? (
          <p className="text-gray-500 dark:text-gray-400 text-center py-8">
            No NFTs yet. Subscribe to a package and pay to receive your membership NFT!
          </p>
        ) : (
          <div className="grid gap-4">
            {nfts.map((nft) => {
              const isClaimed = nft.metadata?.claimed;
              const canClaim = isConnected && !isClaimed;
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-4">
                    {/* NFT Preview */}
                    <div className={`w-16 h-16 rounded-lg flex items-center justify-center ${getTierColor(nft.tier)}`}>
                      <span className="text-2xl">🦷</span>
                    </div>

                    <div>
                      <div className="flex items-center gap-2">
                        <span className={`px-2 py-0.5 rounded-full text-xs font-medium ${getTierColor(nft.tier)}`}>
                          {nft.tier}
                        </span>
